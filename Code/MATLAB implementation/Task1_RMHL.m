...
%
% This script simulates the RMHL algorithm on Task 1 as presented in
...
function y = Task1_RMHL(triallen, res_folder, green, red, orange, purple, grey, rseed)  % Alteration #1
