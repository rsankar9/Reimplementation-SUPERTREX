% Task 2 - SUPERTREX  - 2 Segments - Equal lengths 
...
%
% This script simulates the SUPERTREX algorithm on Task 2 as presented in
...
function y = Task2_ST_Seg2(triallen, res_folder, green, red, orange, purple, grey, rseed) % Alteration #1
