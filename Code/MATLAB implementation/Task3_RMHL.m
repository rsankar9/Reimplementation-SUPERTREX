...
%
% This script simulates the RMHL algorithm on Task 3 as presented in
...
function y = Task3_RMHL(triallen, res_folder, green, red, orange, purple, grey, rseed) % Alteration #1
