...
%
% This script simulates the SUPERTREX algorithm on Task 3 as presented in
...
function y = Task3_ST(triallen, res_folder, green, red, orange, purple, grey, rseed) % Alteration #1
    ...
    beta2 = .05*1;  % additional cost of moving joint 2
